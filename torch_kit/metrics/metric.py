...
class Metric(Hook):
    ...
    def get_metrics(self, metric_type: str, key: int, to_item: bool = True) -> dict:
        """
            Retrieve all metrics for a specific key (epoch or batch)
        """
        metric: dict = {}
        match metric_type:
            case "epoch":
    ...
    def get_metric(
        ...
        """
            Retrieve a specific metric for a given key (epoch or batch index)
        """
        metric: dict = {}
        match metric_type:
            case "epoch":
    ...
    def _set_epoch_metric(self, epoch, name, data) -> None:
        """
            Set a metric for a specific epoch
        """
    ...
    def get_batch_metric(self, batch: int, name: str) -> Any:
        """
            Retrieve a specific batch metric
        """
    ...
    def _before_execute(self, **__) -> None:
        """
            Call clear_metric() to reset metrics before execution
        """
        self.clear_metric()
